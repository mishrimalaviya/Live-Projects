...
const projectData = [
  {
    ...
    image: card4,
    category: "PROJECT-1",
    title: "Built Stunning Website Design ",
    description:
  ...
  },
  {
    ...
    image: card3,
    category: "PROJECT-3",
    title: "Interior Design Conference",
    description:
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <a
          href="#!"
          className="btn btn-primary py-3 px-6 mt-12.5 text-center text-[16px] font-semibold" style={{background:"rgb(26, 57, 106)"}}
        >
          More Project
        </a>
      </div>
